...
$programInstance->id_dex_user_customer = $_GET['id'];
...
if (isset($_POST['submitProgram'])) {
    ...
    if (empty($errors)) {
        ...
        $newProgramInstance->id = $programInstanceList[0]->idProgram;
        $newProgramInstance->updateProgramName();
        $newWorkoutInstance = new workout();
        $newWorkoutInstance->name = $workoutName1;
        $newWorkoutInstance->id_dex_program = $programInstanceList[0]->idProgram;
        $newWorkoutInstance->updateWorkoutName();
        ...
        $exerciceAllkeysInstance->id = $programInstanceList[0]->idExerciceAllKeys;
        $exerciceAllkeysInstance->updateExerciceAllkeys();
        $exerciceAllkeysInstance = new exerciceAllKeys();
        $exerciceAllkeysInstance->id_dex_tempo = $tempo2;
        $exerciceAllkeysInstance->id_dex_recovery = $recovery2;
        $exerciceAllkeysInstance->id = $programInstanceList[1]->idExerciceAllKeys;
        ...
        $exerciceAllkeysInstance->id = $programInstanceList[2]->idExerciceAllKeys;
        ...
        $exerciceAllkeysInstance->id = $programInstanceList[3]->idExerciceAllKeys;
        ...
        if ($exerciceAllkeysInstance->updateExerciceAllkeys()) {
            $isOk = true;
