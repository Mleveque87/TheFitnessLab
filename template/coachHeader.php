        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="formCreateProgram.php">Créer un programme</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="listCustomer.php">Liste de mes clients</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="listProgramCoach.php">Liste de mes programmes</a>
                    </li> 
                </ul>
...
<!--                            <img src="https://mdbootstrap.com/img/Photos/Avatars/avatar-2.jpg" class="rounded-circle z-depth-0" alt="avatar image">-->
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-secondary" aria-labelledby="navbarDropdownMenuLink-55">
                            <a class="dropdown-item" href="profilCoach.php">Mon Profil</a>
